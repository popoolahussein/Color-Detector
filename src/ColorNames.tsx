const colorNames: string[] = [
    ...
    'gray', 'violet', 'indigo', 'cyan', 'magenta', 'teal', 'lime', 'maroon', 'navy', 'olive',
    'aqua', 'beige', 'bisque', 'blanchedalmond', 'blueviolet', 'burlywood', 'cadetblue', 'chartreuse',
    ...
    'forestgreen', 'fuchsia', 'gainsboro', 'ghostwhite', 'gold', 'goldenrod', 'greenyellow', 'honeydew',
    'hotpink', 'hsl', 'lightblue', 'lightcoral', 'lightcyan', 'lightgoldenrodyellow', 'lightgray',
    ...
    'purple', 'rebeccapurple', 'rosybrown', 'royalblue', 'saddlebrown', 'salmon', 'sandybrown',
